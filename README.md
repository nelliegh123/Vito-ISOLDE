...
2. In detectorConstruction.cc you include your new header file as _#include "detectorGeometryDeVito.hh"_. Scoll down to _Defining Detector_ and call your new function. It may look like:
```cpp
